...
export const RForm: FC<any> = ({ errors, touched }) => (
  <>
    ...
    <div className="form__item">
      ...
      {errors.email && touched.email && <div className="form__item__error">{errors.email}</div>}
    </div>
...
export const LForm: FC<any> = ({ errors, touched }) => (
  <>
    <div className="form__item">
      ...
      {errors.login && touched.login && <div className="form__item__error">{errors.login}</div>}
    </div>
